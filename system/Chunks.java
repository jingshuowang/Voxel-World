...
public class Chunks {
    // Top level controller code can go here later


    // --- Nested from system/Chunk.java ---
    ...
    public static class Chunk {
        ...
        public int vboOffset = -1; // VRAM mapping linearly mapped offset
                    ...
                    for (int y = 0; y < CHUNK_SIZE; y++) {
                        ...
                        if (globalY <= terrainHeight) {
                            ...
                            if (globalY == terrainHeight) {
                                ...
                                if (terrainHeight > WATER_LEVEL + 120) {
                                    setBlock(x, y, z, SNOW); // High = Snow
                                } else if (terrainHeight > WATER_LEVEL + 65) {
    ...
    // --- Nested from system/SimplexNoise.java ---
    /*
    ...
    public static class SimplexNoise {
        ...
        // Quick and dirty randomizer for seeding
        static {
            for (int i = 0; i < 256; i++) {
                p[i] = (int) Math.floor(Math.random() * 256);
                p[i + 256] = p[i];
            }
        }
